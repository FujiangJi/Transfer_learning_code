...
from Models import data_extraction,transfer_learning_model, rsquared
warnings.filterwarnings('ignore')

def fine_tune_ANN(tr, tr_obs, refl_obs, train_size, RTM, n_iterations, data_type):
    X = refl_obs
    y = tr_obs
...
for model in RTMs:
    for train_size in ts:
        p = pool.apply_async(func=fine_tune_ANN,args= (tr, tr_obs, refl_obs, train_size, model, 10, data_type))
